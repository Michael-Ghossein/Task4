    ...
    fetch(apiUrl)
        ...
        .catch(error => {
            ...
            weatherElement.innerHTML = `
                <p>Error fetching weather data, location not found!</p>
                <img src="icons/location.png" alt="Error image" style="width: 512px; height: auto; display: block; margin: 0 auto;">
            `;
        });
}
